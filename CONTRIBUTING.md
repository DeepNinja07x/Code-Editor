...
-  Fork this [repository](https://github.com/DeepNinja07x/Code-Editor)
  
-  Clone the forked https://github.com/<Your_Username>/Code-Editor
...
- Add the upstream (main project's) repo's URL
    ...
    > git remote add upstream https://github.com/DeepNinja07x/Code-Editor.git
